...
<template>
    <div class="landing-page h-full w-full">
        <div class="min-h-screen h-screen w-full bg-pink-700 bg-gradient-to-br from-pink-800 to-purple-950">
            <div class="flex flex-col h-full">
                <div class="w-full flex flex-col items-center m-0 p-0">
                    <Navbar />
                </div>

                <div class="flex flex-col align-center gap-0 text-center h-full mt-[-80px]">
                    <h1 class="uppercase text-8xl !text-white font-bold" data-aos="fade-down" data-aos-once="false">
                        DEVMART
                    </h1>
                    <div class="text-2xl" data-aos="fade-up" style="color:#fff;margin-top:4px;">
            ...
            <div class="d-grid">
                <div class="col-span-12 text-center mb-3">
                    <div class="max-w-screen-md mx-auto">
                        <h2 class="text-4xl font-bold text-white" data-aos="fade-right">
                            Go custom.
                        </h2>
                        <p class="text-base mt-3" data-aos="fade-left">
                            Order a custom-built Minecraft plugin, website, build or Discord bot
                            from
                            GCNT
                        </p>
                    </div>
                ...
                <div class="col-span-12 grid auto-cols-max grid-cols-2 gap-5 mt-5">
                    <div class="card home-card flex flex-col justify-center" data-aos="zoom-in">
                        ...
                        <h3 class="text-base font-bold uppercase mt-4 text-white">
                            Starting from 12 EUR/hour
                        </h3>
                        <p class="text-base mt-3">
                            Custom development rates range from 12 to 16 EUR per hour and are hourly
                            charged.
                        </p>
                    </div>
                    <div class="card home-card" data-aos="zoom-out">
                        ...
                        <p class="text-base mt-3">
                            Get the source of your project at no additional costs, provided through
                            GitHub.
                        </p>
                    </div>
                    <div class="card home-card" data-aos="zoom-out">
                        ...
                        <p class="text-base mt-3">
                            Expect only max performance of our products and nothing less.
                        </p>
                    </div>
                    <div class="card home-card" data-aos="zoom-in">
                        ...
                        <p class="text-base mt-3">
                            Our products have sold over 120.000 times with an average rating of 4.6
                            stars and are well maintained.
                        </p>
                    </div>
                    <div class="card home-card" data-aos="zoom-in">
                        <div class="icon flex flex-col align-center">
                        ...
                        <p class="text-base mt-3">
                            Java, JavaScript, NodeJS, PHP, HTML, CSS, SQL, MongoDB, Redis.
                        </p>
                    </div>
                    <div class="card home-card" data-aos="zoom-out">
                        <div class="icon flex flex-col align-center">
                        ...
                        <p class="text-base mt-3">
                            Experiencing any issues with our products or have any questions? Don't
                ...
                <div class="col-span-12 flex items-center flex-row">
                    ...
                    <div class="w-full text-center flex flex-col align-center">
                        <div class="max-w-screen-md mx-auto">
                            ...
                            <p class="text-base mt-3">
                                Professional free and premium Minecraft Server Plugins for everyone.
