...
const pages = computed(() => {
    ...
    if (lastPage <= 7) {
        for (let i = 1; i <= lastPage; i++) {
            pages.push({page: i, active: i === currentPage, disabled: false})
        }
        return pages
    }
    ...
    if (currentPage <= 3) {
        ...
        pages.push({page: lastPage, active: false, disabled: false})
        return pages
    }
    ...
    pages.push({page: 1, active: false, disabled: false})
    pages.push({page: '...', active: false, disabled: true})
    pages.push({page: currentPage - 1, active: false, disabled: false})
    pages.push({page: currentPage, active: true, disabled: false})
    pages.push({page: currentPage + 1, active: false, disabled: false})
    pages.push({page: '...', active: false, disabled: true})
    pages.push({page: lastPage, active: false, disabled: false})
